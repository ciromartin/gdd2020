...
CREATE TABLE [WHITE_WALKERS].[FACTURA] (
	...
	[FACTURA_ID_CLIENTE] [decimal](18, 0) NULL,	
	[FACTURA_ID_SUCURSAL] [decimal](18, 0) NULL,	
...
ORDER BY COMPRA_NRO ASC

GO

SELECT M.FACTURA_NRO,C.ID_CLIENTE  INTO #FAC_CLIENTE 
...
SELECT M.FACTURA_NRO,S.ID_SUCURSAL  INTO #FAC_SUCURSAL 
FROM [gd_esquema].[Maestra] M
